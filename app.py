...
def venues():
  ...
  for city_state in city_state_results:
    ...
    venues = db.session.query(Venue)\
      ...
      .all()
    # print(venues)
    # [<Venue ID: 4 | Venue Name: The Musical Hop>, <Venue ID: 6 | Venue Name: Park Square Live Music & Coffee>]
    # [<Venue ID: 5 | Venue Name: The Dueling Pianos Bar>]
    venues_result_list = []
    for venue in venues:
      venue_id = venue.id
...
def show_venue(venue_id):
  ...
  id, name, genres, address, city, state, phone, website_link, facebook_link, seeking_talent, image_link =\
    venue_data[0], venue_data[1], venue_data[2], venue_data[3], venue_data[4], venue_data[5], venue_data[6], venue_data[7], venue_data[8], venue_data[9], venue_data[10]

  past_shows = find_past_shows_by_venue(id)
  upcoming_shows = find_upcoming_shows_by_venue(id)
  past_shows_count = search_num_past_shows_by_venue(id)
  upcoming_shows_count = search_num_upcoming_shows_by_venue(id)
